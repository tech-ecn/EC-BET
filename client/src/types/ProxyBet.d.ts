...
export interface ProxyBet extends BaseContract {
	constructor(jsonInterface: any[], address?: string, options?: ContractOptions): ProxyBet
	clone(): ProxyBet
	methods: {
		/**
		...
		upgradeTo(_logic: string, _data: string | number[]): NonPayableTransactionObject<void>
	}
	events: {
